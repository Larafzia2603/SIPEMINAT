<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Dashboard Kaprodi</h2>
    ...
    <div class="mx-auto max-w-7xl space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 animate-slide-up">
            ...
            <div class="stat-card">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600">Rules Aktif</p>
            ...
            <div class="stat-card">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600">Topik Minat</p>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="card p-6 animate-on-scroll">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-600 mb-4">Kelola sistem rekomendasi dan data master program studi</p>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg hover:bg-primary-50 transition-colors duration-200">
                                    ...
                                    <div>
                                        <p class="font-medium text-gray-900">Statistik Minat</p>
                                        <p class="text-sm text-gray-600">Lihat statistik minat per mata kuliah dan topik</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg hover:bg-primary-50 transition-colors duration-200">
                                    ...
                                    <div>
                                        <p class="font-medium text-gray-900">Kelola Rules</p>
                                        <p class="text-sm text-gray-600">Atur aturan rekomendasi berbasis rule engine</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg hover:bg-primary-50 transition-colors duration-200">
                                    ...
                                    <div>
                                        <p class="font-medium text-gray-900">Pantau Distribusi</p>
                                        <p class="text-sm text-gray-600">Monitor distribusi pilihan peminatan mahasiswa</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card p-6 animate-on-scroll">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <a href="{{ route('kaprodi.master-data.index') }}" class="flex items-center gap-4 p-4 border-2 border-gray-200 rounded-xl hover:border-primary-500 hover:bg-primary-50 transition-all duration-200 group">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Kelola data master</p>
                            </div>
                        </a>

                        <a href="{{ route('kaprodi.rules.index') }}" class="flex items-center gap-4 p-4 border-2 border-gray-200 rounded-xl hover:border-primary-500 hover:bg-primary-50 transition-all duration-200 group">
                            <div class="w-12 h-12 bg-primary-100 rounded-xl flex items-center justify-center group-hover:bg-primary-600 transition-colors duration-200">
                                <svg class="w-6 h-6 text-primary-600 group-hover:text-white transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                            ...
                            <div>
                                <p class="font-semibold text-gray-900">Kelola Rules</p>
                                <p class="text-sm text-gray-600">Atur rule rekomendasi</p>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="card p-6 bg-gradient-to-br from-primary-50 to-primary-100 border-primary-200 animate-on-scroll">
                    ...
                    <p class="text-sm text-gray-700 leading-relaxed">
                        Sebagai Kaprodi, Anda dapat mengelola seluruh data master dan aturan rekomendasi untuk program studi.
                    </p>
                </div>
                ...
                <div class="card p-6 animate-on-scroll">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h3 class="font-semibold text-gray-900">Tips Pengelolaan</h3>
                    </div>
                    <ul class="space-y-2 text-sm text-gray-700">
                        <li class="flex items-start gap-2">
                            ...
                            <span>Update rules secara berkala</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <svg class="w-5 h-5 text-primary-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <span>Monitor statistik peminatan</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <svg class="w-5 h-5 text-primary-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <span>Evaluasi efektivitas rules</span>
                        </li>
                    </ul>
                </div>
            </div>
